...
//	[] s=1 -> 0.5:(s'=0) + 0.5:(s'=1);	//commented for simplisity and smaller case
	...
	[] a=0 -> 1/8:(a'=0) + 1/8:(a'=1) + 1/8:(a'=2) + 1/8:(a'=3) + 1/8:(a'=4) + 1/8:(a'=5) + 1/8:(a'=6) + 1/8:(a'=7);
	[] a=1 & (d!=0 ) -> 1/8:(a'=0) + 1/8:(a'=1) + 1/8:(a'=2) + 1/8:(a'=3) + 1/8:(a'=4) + 1/8:(a'=5) + 1/8:(a'=6) + 1/8:(a'=7);
	[] a=2 & (d!=0) -> 1/8:(a'=0) + 1/8:(a'=1) + 1/8:(a'=2) + 1/8:(a'=3) + 1/8:(a'=4) + 1/8:(a'=5) + 1/8:(a'=6) + 1/8:(a'=7);
	[] a=3 & (d!=0) -> 1/8:(a'=0) + 1/8:(a'=1) + 1/8:(a'=2) + 1/8:(a'=3) + 1/8:(a'=4) + 1/8:(a'=5) + 1/8:(a'=6) + 1/8:(a'=7);
	[] a=4 & (d!=0 ) -> 1/8:(a'=0) + 1/8:(a'=1) + 1/8:(a'=2) + 1/8:(a'=3) + 1/8:(a'=4) + 1/8:(a'=5) + 1/8:(a'=6) + 1/8:(a'=7);
	[] a=5 & (d!=0 ) -> 1/8:(a'=0) + 1/8:(a'=1) + 1/8:(a'=2) + 1/8:(a'=3) + 1/8:(a'=4) + 1/8:(a'=5) + 1/8:(a'=6) + 1/8:(a'=7);
	[] a=6 & (d!=0) -> 1/8:(a'=0) + 1/8:(a'=1) + 1/8:(a'=2) + 1/8:(a'=3) + 1/8:(a'=4) + 1/8:(a'=5) + 1/8:(a'=6) + 1/8:(a'=7);
	[] a=7 & (d!=0 ) -> 1/8:(a'=0) + 1/8:(a'=1) + 1/8:(a'=2) + 1/8:(a'=3) + 1/8:(a'=4) + 1/8:(a'=5) + 1/8:(a'=6) + 1/8:(a'=7);
